...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "sta01" do |sta01|  
    ...
    sta01.vm.provision "shell", path: "script.sh", args: "10102"
  ...
  config.vm.define "sta02" do |sta02|  
    ...
    sta02.vm.provision "shell", path: "script.sh", args: "10103"
  end
  ...
  config.vm.define "sta03" do |sta03|  
    ...
    sta03.vm.provision "shell", path: "script.sh", args: "10104"
  end
  ...
  config.vm.define "sta04" do |sta04|  
    ...
    sta04.vm.provision "shell", path: "script.sh", args: "10105"
  end
  ...
  config.vm.define "sta05" do |sta05|  
    ...
    sta05.vm.provision "shell", path: "script.sh", args: "10106"
  end
  ...
  config.vm.define "sta06" do |sta06|  
    ...
    sta06.vm.provision "shell", path: "script.sh", args: "10107"
  end
  ...
  config.vm.define "sta07" do |sta07|  
    ...
    sta07.vm.provision "shell", path: "script.sh", args: "10108"
  end
  ...
  config.vm.define "sta08" do |sta08|  
    ...
    sta08.vm.provision "shell", path: "script.sh", args: "10109"
  end
  
  config.vm.define "sta09" do |sta09|  
    # Create a public network, which generally matched to bridged network.
    sta09.vm.network "public_network", ip: "192.168.0.110", bridge: "eno1"
    # Provider-specific configuration: VirtualBox
    ...
    sta09.vm.provision "shell", path: "script.sh", args: "10110"
  end
  
  config.vm.define "sta10" do |sta10|  
    # Create a public network, which generally matched to bridged network.
    sta10.vm.network "public_network", ip: "192.168.0.111", bridge: "eno1"
    # Provider-specific configuration: VirtualBox
    ...
    sta10.vm.provision "shell", path: "script.sh", args: "10111"
  end
  
  config.vm.define "sta11" do |sta11|  
    # Create a public network, which generally matched to bridged network.
    sta11.vm.network "public_network", ip: "192.168.0.112", bridge: "eno1"
    # Provider-specific configuration: VirtualBox
    ...
    sta11.vm.provision "shell", path: "script.sh", args: "10112"
  end
  
  config.vm.define "sta12" do |sta12|  
    # Create a public network, which generally matched to bridged network.
    sta12.vm.network "public_network", ip: "192.168.0.113", bridge: "eno1"
    # Provider-specific configuration: VirtualBox
    ...
    sta12.vm.provision "shell", path: "script.sh", args: "10113"
  end
  
  config.vm.define "sta13" do |sta13|  
    # Create a public network, which generally matched to bridged network.
    sta13.vm.network "public_network", ip: "192.168.0.114", bridge: "eno1"
    # Provider-specific configuration: VirtualBox
    ...
    sta13.vm.provision "shell", path: "script.sh", args: "10114"
  end
  
  config.vm.define "sta14" do |sta14|  
    # Create a public network, which generally matched to bridged network.
    sta14.vm.network "public_network", ip: "192.168.0.115", bridge: "eno1"
    # Provider-specific configuration: VirtualBox
    ...
    sta14.vm.provision "shell", path: "script.sh", args: "10115"
  end
  
  config.vm.define "sta15" do |sta15|  
    # Create a public network, which generally matched to bridged network.
    sta15.vm.network "public_network", ip: "192.168.0.116", bridge: "eno1"
    # Provider-specific configuration: VirtualBox
    ...
    sta15.vm.provision "shell", path: "script.sh", args: "10116"
  end
  
  config.vm.define "sta16" do |sta16|  
    # Create a public network, which generally matched to bridged network.
    sta16.vm.network "public_network", ip: "192.168.0.117", bridge: "eno1"
    # Provider-specific configuration: VirtualBox
    ...
    sta16.vm.provision "shell", path: "script.sh", args: "10117"
  end
